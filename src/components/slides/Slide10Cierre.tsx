  ...
  return (
    <div className="w-full max-w-5xl px-8">
      <div className="mb-8 text-center">
        <span className="font-mono text-lg text-accent-green">CIERRE // RECURSOS_Y_CONTACTO</span>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        {[
          ...
          <div key={col.title} className="bento-card p-10">
            <div className="font-mono text-base text-accent-green mb-3">{col.title}</div>
      ...
      <div className="bento-card p-10 text-center">
        <div className="font-mono text-base text-gray-400 mb-6">REFERENCIAS</div>
        <div className="font-mono text-base text-gray-300 space-y-1">
        ...
        <div className="mt-6 pt-6 border-t border-white/10">
          ...
          <div className="font-mono text-base text-gray-400 mt-2">Sumate al grupo - Construi el futuro digital de Argentina</div>
        </div>
      </div>
    </div>
  );
